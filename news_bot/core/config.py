...
GEMINI_FLASH_MODEL = os.getenv("GEMINI_FLASH_MODEL", "gpt-5.4")
GEMINI_SUMMARY_MODEL = os.getenv("GEMINI_SUMMARY_MODEL", "gpt-5.4")
GEMINI_PRO_MODEL = os.getenv("GEMINI_PRO_MODEL", "gpt-5.4")
